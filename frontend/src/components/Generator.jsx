      ...
      <div className="h-full flex justify-between">
        <div className="h-full w-1/2 flex justify-center items-center">
          <div
            ...
            className="w-5/6 p-5 rounded-lg"
          >
            <div className="h-full w-full h-8 flex">
              <input
                type="text"
              ...
              <div
                ...
                className=" cursor-pointer flex justify-center items-center p-2 w-1/6 rounded-tr rounded-br"
              >
            ...
            {result ? (
              <button
                ...
                className=" btn w-full mt-3 p-1 rounded-lg font-medium hover:border-black"
              >
                Save Password
              </button>
            ) : null}
            <form onSubmit={handleSubmit}>
              ...
              <div className="my-2 w-full">
                <button
                  type="submit"
                  style={{ border: "1px solid white",backgroundColor:'gray' }}
                  className=" hover:text-white w-full p-2 rounded-lg font-medium"
                >
                  Generate Password
                </button>
              </div>
        ...
        <div
          style={{ border: "1px solid white" }}
          className="h-5/6 w-1/2  mt-10 mx-5 rounded-lg"
        >
            ...
            {collection.length > 0 ? (
              collection.map((password) => (
                <div
                  key={password._id}
                  style={{ border: "1px solid white" }}
                  className=" m-3 p-3 rounded flex justify-between"
                >
                  ...
                  <div className="flex">
                    {visible === password._id ? (
                      ...
                      <LiaEyeSlash
                        ...
                        className="text-2xl mx-1 cursor-pointer text-stone-300"
                      />
                    )}
                    <BsTrashFill
                      onClick={() => deleteHandler(password._id)}
                      className="text-2xl mx-1 cursor-pointer text-white"
                    />
                  </div>
                </div>
              ))
